...
def savn_val_unseen(
    ...
    glove = Glove(args.glove_file)
    scenes, possible_targets, targets, rooms = get_unseen_data(args.scene_types, args.val_scenes)
    num = 0 # name_to_num(scene_type)
    scenes = scenes[num]
    targets = targets[num]
    rooms = rooms[num]
...
def savn_val_seen(
    ...
    glove = Glove(args.glove_file)
    scenes, possible_targets, targets, rooms = get_seen_data(args.scene_types, args.val_scenes)
    num = 0 # name_to_num(scene_type)
    scenes = scenes[num]
    targets = targets[num]
    rooms = rooms[num]
